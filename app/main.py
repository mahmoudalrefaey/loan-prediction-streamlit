...
def add_predictions(input_data):
    ...
    print("Input array before scaling:", input_array)  # Debug print
...
def add_sidebar():
    ...
    for label, key in dropdown_labels:
        ...
        unique_values = data[key].unique()  # Get the unique options for dropdown
...
def main():
    ...
    with col1:
        ...
        if input_data['House_Ownership'] == np.int32(0):  # Direct comparison
